...
$(document).ready(function() {
  $("input, textarea").focus(function() {
    $(this).prev().children().addClass("active"), $(this).next().addClass("active"), $(this).parent().find(".lenghtCounter").show()
  }).blur(function() {
